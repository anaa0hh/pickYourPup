...
function userSelection(selection) {
  ...
  var pupVideo = 'https://www.youtube.com/embed/kI4EbABtJQ0';
  ...
  if (pupVideo) {
    ...
    iframe.setAttribute('src', pupVideo);
